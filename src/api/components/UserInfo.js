...
const UserInfo = ({
  ...
  const handleDelete = () => {
    axios
      .delete(
        `http://172.16.10.132:3574/nc/early_adapters_esxl/api/v1/users/${id}`,
        {
          headers: {
            'xc-auth':
    ...
    <>
      <article className='user-info'>
        ...
        <div className='user-info_buttons'>
          <button className='user-info_update' onClick={handleUpdate}>
            Update
          </button>
          <button className='user-info_delete' onClick={handleDelete}>
            Delete
          </button>
        </div>
      </article>
